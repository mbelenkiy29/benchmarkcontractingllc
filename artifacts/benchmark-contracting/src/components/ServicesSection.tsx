...
function ServiceCard({ service, index }: { service: typeof services[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`border bg-white rounded-sm overflow-hidden transition-all duration-300 shadow-sm hover:shadow-md hover:border-neutral-900/40 ${
        open ? "border-neutral-900/40 shadow-md" : "border-neutral-200"
      }`}
    >
      <button
      ...
      >
        <div className="w-12 h-12 rounded-sm bg-neutral-100 flex items-center justify-center shrink-0 group-hover:bg-neutral-200 transition-colors">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-neutral-500 mt-1 leading-snug">{service.description}</p>
        </div>
        <ChevronDown
          className={`w-5 h-5 text-neutral-900 shrink-0 transition-transform duration-300 ${open ? "rotate-180" : ""}`}
        />
      </button>
...
export default function ServicesSection() {
  return (
    <section id="services" className="py-24 md:py-32 bg-neutral-50 relative">
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <span className="text-neutral-900 font-semibold uppercase tracking-wider text-sm">What We Do</span>
            <div className="h-px w-12 bg-neutral-900" />
          </div>
