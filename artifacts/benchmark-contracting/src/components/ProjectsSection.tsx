...
const projects = [
  ...
  },
  {
    ...
    category: "Commercial",
    description: "Contributed to the build-out of a modern glass-facade corporate headquarters — precision engineering from structural steel to interior finishes.",
  ...
  },
  {
    ...
    category: "Commercial",
    description: "Contributed to large-scale commercial construction for a leading technology company, blending industrial design with sustainable green architecture.",
  ...
  },
  {
    ...
    description: "Contributed to a complete residential kitchen transformation — custom cabinetry, marble countertops, premium appliances, and designer pendant lighting.",
  ...
  },
  {
    ...
    description: "Contributed to complex ground-up construction in lower Manhattan — structural steel, curtain wall systems, and precision coordination in a dense urban environment.",
  ...
  },
  {
    ...
    description: "Contributed to a full commercial kitchen installation for a high-volume NYC restaurant — NSF-compliant equipment layout, ventilation systems, and fire suppression.",
  ...
  },
  {
    ...
    category: "Construction",
    description: "Contributed to high-stakes construction work at one of New York City's most recognized sites — precision welding, structural reinforcement, and full compliance with landmark requirements.",
    location: "Lower Manhattan, NYC",
  },
];
