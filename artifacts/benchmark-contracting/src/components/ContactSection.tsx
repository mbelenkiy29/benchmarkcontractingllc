...
export default function ContactSection() {
  ...
  const inputClass =
    "w-full bg-white/5 border border-white/15 text-white placeholder-white/30 rounded-sm px-4 py-3 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all duration-200";

  return (
    <section id="contact" className="py-24 md:py-32 bg-black relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(255,102,0,0.05)_0%,_transparent_60%)]" />
        ...
        <div className="grid lg:grid-cols-5 gap-12 max-w-6xl mx-auto">
          ...
          >
            <form
              ...
              className="border border-white/10 rounded-sm p-8 bg-white/5 space-y-5"
            >
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  <label className="block text-xs text-white/50 uppercase tracking-wider mb-2 font-semibold">
